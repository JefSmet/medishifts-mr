...
const Calendar = ({ month, year, events }) => {
  ...
  return (
    <div className="lg:flex lg:h-full lg:flex-col">
      <header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none dark:border-gray-700 dark:bg-gray-800">
        <h1 className="font-semibold leading-6 text-gray-900 dark:text-white">
        ...
        <div className="flex items-center">
          <div className="relative flex items-center rounded-md bg-white shadow-sm md:items-stretch">
            <button
              type="button"
              className="dark flex h-9 w-12 items-center justify-center rounded-l-md border-y border-l border-gray-300 pr-1 text-gray-400 hover:text-gray-500 focus:relative md:w-9 md:pr-0 md:hover:bg-gray-50"
            >
      ...
      <div className="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col">
        ...
        <div className="text-current-month flex bg-gray-200 text-xs leading-6 lg:flex-auto">
            ...
            {days.map((day) => (
              <div
                ...
                className={classNames(
                  day.isCurrentMonth
                    ? "bg-white"
                    : "bg-other-month text-other-month",
                  "relative px-3 py-2",
                )}
              >
                <time
            ...
            {days.map((day) => (
              <button
                ...
                className={classNames(
                  ...
                  !day.isSelected && day.isToday && "font-bold text-indigo-600",
                  !day.isSelected &&
                    day.isCurrentMonth &&
                    !day.isToday &&
                    "text-gray-900",
